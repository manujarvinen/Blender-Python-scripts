# Credits:
# Jasper van Nieuwenhuizen (https://blender.stackexchange.com/a/7142/8282)

# Usage:
# - First select the object you want to show in place of the particles (dupli object) 
# - And then select the object with the particle system. 
# - Then run the following script. 
# - But be aware, it can get quite slow if you have lots of particles (for 5000 particles and Suzanne as dupli object, it took almost 4 minutes on my computer).
